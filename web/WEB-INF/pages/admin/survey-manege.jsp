...
<head>
    ...
    <script type="text/javascript" src="<%=request.getContextPath()%>/assets/js/core/libraries/jquery_ui/interactions.min.js"></script>
                    ...
                    <div class="category-content no-padding">
                        <ul class="navigation navigation-main navigation-accordion">
                            ...
                            <li>
                                ...
                                <ul>
                                    <li><a href="/admin/survey/view">Survey</a></li>
                                </ul>
                            </li>
            ...
            <div class="content">
                ...
                <div class="panel panel-flat">
                    <div class="panel-heading">
                        <h5 class="panel-title">Manage Survey</h5>
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" action="/admin/survey/update" method="post">
                            <input type="hidden" name="surveyId" value="<%=s.getId()%>">
                            <fieldset class="content-group">

                                <div class="form-group">
                                    <label class="control-label col-lg-2">Members</label>
                                    <div class="col-lg-10">
                                        <select multiple="multiple" class="select" name="members">
                                            <optgroup label="Members">
                                                <%for(User member  : members){  %>
                                                    <option value="<%=member.getId()%>" <%if(member.isMember()){%>selected="selected" <%}%>> <%=member.getName()%>&nbsp;<%=member.getSurname()%></option>
                                                <% } %>
                                            </optgroup>
                                        </select>
                                    </div>
                            ...
                            <fieldset class="content-group">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-lg-2">Questions</label>
                                    <div class="col-lg-10">
                                        <select multiple="multiple" class="select" name="questions">
                                            <optgroup label="Questions">
                                                <%for(ProductDetail detail  : questions){  %>


                                                <option value="<%=detail.getId()%>" <%if(detail.isQuestion() ){%> selected="selected"  <%}%>>
                                                    <%=detail.getType().getType()%>&nbsp;
                                                    <%=detail.getPriceMin()%>&nbsp;-<%=detail.getPriceMax()%>&nbsp;
                                                </option>
