<%@ page import="am.pm.dataaccess.model.ProductCategory" %>
            ...
            <div class="page-header">
                <div class="page-header-content">
                    <div class="page-title">
                        <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Products</span> - Categories</h4>
                    </div>
                </div>
            ...
            <div class="content">
                ...
                <div class="panel panel-flat">
                    ...
                    <div class="panel-body">
                         <form class="form-horizontal" action="/product-category/add" method="post">
                ...
                <div class="panel panel-flat">
                    ...
                    <table class="table datatable-basic">
                        ...
                        <%  List<ProductCategory> productCategories = (List<ProductCategory>)request.getAttribute("productCategories");
                            if(!Utils.isEmpty(productCategories)){
                                int index = 1;
                            ...
                            <td class="text-center">
                                <ul class="icons-list">
                                    <li class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-right">
                                            <li><a href="/product-category/delete?id=<%=productCategory.getId()%>">Delete</a></li>
                                        </ul>
                                    </li>
                                </ul>
                            </td>
