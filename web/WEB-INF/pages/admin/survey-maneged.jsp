                            ...
                            <%for(User member : members){%>
                                <li class="media">
                                    <div class="media-left">
                                        <a href="/admin/survey/managed?id=<%=s.getId()%>&userId=<%=member.getId()%>">
                                            <img alt="" class="img-circle" src="<%=request.getContextPath()%>/assets/images/placeholder.jpg">
                                        </a>
                                    </div>

                                    <div class="media-body">
                                        <div class="media-content"><%=member.getName()%>&nbsp;<%=member.getSurname()%></div>
                                    </div>
                                </li>
                            <%}%>
                        </ul>
