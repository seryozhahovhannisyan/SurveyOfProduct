<%@ page import="am.pm.dataaccess.model.ProductType" %>
            ...
            <div class="page-header">
                <div class="page-header-content">
                    <div class="page-title">
                        <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Products</span> - Types</h4>
                    </div>
                </div>
            ...
            <div class="content">
                ...
                <div class="panel panel-flat">
                    <div class="panel-heading">
                        <h5 class="panel-title">Add Product category</h5>
                    ...
                    <div class="panel-body">
                         <form class="form-horizontal" action="/product-type/add" method="post">
                ...
                <div class="panel panel-flat">
                    <div class="panel-heading">
                        <h5 class="panel-title">Product Types</h5>
                        <div class="heading-elements">
                            <ul class="icons-list">
                                <li><a data-action="collapse"></a></li>
                                <li><a data-action="reload"></a></li>
                            ...
                            <td class="text-center">
                                <ul class="icons-list">
                                    <li class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-right">
                                            <li><a href="/product-type/delete?id=<%=type.getId()%>">Delete</a></li>
                                        </ul>
                                    </li>
                                </ul>
                            </td>
